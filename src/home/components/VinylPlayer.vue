  ...
  >
    ...
    <div v-else class="vinyl-panel">
      <div class="panel-header" @pointerdown.prevent="onDragStart">
        <span class="panel-title">♫ 蓄音機</span>
        <button class="collapse-btn" title="閉じる" @click.stop="isCollapsed = true">✕</button>
      </div>
...
function onDragMove(e: PointerEvent) {
  ...
  // right は左向きが正なので dx は反転；top は下向きが正
