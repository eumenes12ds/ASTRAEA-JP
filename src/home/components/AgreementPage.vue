      ...
      <div v-if="showAgreementModal" class="modal-overlay" @click.self="showAgreementModal = false">
        <div class="modal-content agreement-modal">
          ...
          <div class="modal-scroll-body">
            <h4>一、総則</h4>
            <p>
              「ASTRAEA」（以下「本プロジェクト」といいます）をご利用いただきありがとうございます。本プロジェクトは
              SillyTavern
            ...
            <ul>
              ...
              <li>
                本プロジェクトには第三者のオープンソースコンポーネントや素材が含まれる場合があり、それぞれ対応するオープンソースライセンスに従います。
              </li>
              <li>
                本プロジェクトのいかなる内容も<strong>商業目的</strong>に使用してはなりません。
              </li>
            </ul>
            ...
            <ul>
              <li>
                本プロジェクトは<strong>個人学習、娯楽、および非商業的な交流</strong>のためにのみ利用できます。
              </li>
              <li>
                本プロジェクトを逆コンパイル、リバースエンジニアリングしたり、いかなる方法でもソースコードの抽出を試みてはなりません（公開済みの部分を除く）。
              </li>
              <li>
                本プロジェクトの内容を再配布、転売、または二次創作物として商品化してはなりません。
              </li>
            ...
            <ul>
              ...
              <li>
                本プロジェクトが生成するテキスト内容は AI モデルによって生成されます。制作チームは
                AI
                が生成した具体的な内容について<strong>審査義務および法的責任を負いません</strong>。
              </li>
              <li>
                ユーザーは AI
                生成内容の妥当性と適切性を自ら判断し、自身の利用行為に対して責任を負うものとします。
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                AI サービスとの通信は、ご自身で設定した API
                によって行われ、関連するデータの取り扱いは、対応する AI
                サービス提供者のプライバシーポリシーに従います。
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                本契約のいずれかの条項が無効または執行不能と判断された場合でも、その他の条項は引き続き有効です。
              </li>
              <li>
                ご不明な点がある場合は、プロジェクトの公式チャンネルを通じて制作チームにご連絡ください。
              </li>
              <li>
