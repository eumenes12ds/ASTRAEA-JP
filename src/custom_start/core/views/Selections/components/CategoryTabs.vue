...
const categories = [
  { key: 'equipment', label: '装備', icon: 'fa-solid fa-shield-halved' },
  { key: 'item', label: '道具', icon: 'fa-solid fa-box-open' },
  { key: 'asset', label: '資産', icon: 'fa-solid fa-building-columns' },
  { key: 'skill', label: 'スキル', icon: 'fa-solid fa-wand-magic' },
] as const;
