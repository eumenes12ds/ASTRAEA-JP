  ...
  <div class="selected-panel">
    ...
    <div class="panel-body themed-scrollbar">
      ...
      <div v-if="totalCount === 0" class="empty-state">
        ...
        <div class="empty-text">まだアイテムを選択していません</div>
      </div>
    </div>
    ...
    <div class="panel-footer">
      ...
      <button v-if="totalCount > 0" class="clear-btn" @click="handleClear">すべてクリア</button>
    </div>
  </div>
</template>
