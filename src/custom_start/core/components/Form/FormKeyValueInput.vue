...
/**
 * キーと値のペア入力コンポーネント（効果などの構造化フィールド用）
 */
...
const props = withDefaults(defineProps<Props>(), {
  placeholderKey: 'フィールド名を入力してください',
  placeholderValue: '対応する内容を入力してください',
  maxItems: 20,
  minItems: 0,
  disabled: false,
  addButtonText: 'エントリを追加',
  emptyText: 'エントリはまだありません。下のボタンから追加してください',
});
