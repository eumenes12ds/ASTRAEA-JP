/** @deprecated `WolrdbookEntry` を使用してください */
type LorebookEntry = {
  uid: number;
...
/** @deprecated `getWorldbook` を使用してください */
